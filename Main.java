...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("a for left direction \nd for right direction");
		System.out.println("w for upward direction \ns for downward direction");

		while (isRunning) {
			screen.PrintScreen();
			System.out.println("Enter the direction of Snake: ");
			...
			case 's':
				...
				break;
			default:
				System.out.println("Enter correct movement");
			}
		}
	}
